...
function AddProductPage() {
  ...
  const [categoryName, setCategoryName] = useState("Party Wear Dresses");
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setLoading(true);
    const toastId = toast.loading("Adding product listing...");
    try {
      ...
      if (res.success) {
        toast.success("Outfit listed successfully!", { id: toastId });
    ...
    <div className="flex flex-col gap-6 max-w-4xl mx-auto">
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <h1 className="text-xl font-bold tracking-tight mt-0.5">List New Outfit</h1>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-6">
        ...
        <div className="flex items-center justify-end gap-3 border-t border-border/40 pt-6">
          ...
          <Button
            ...
            disabled={loading}
          >
            {loading ? "Saving listing..." : "Publish Outfit Listing"}
          </Button>
        </div>
      </form>
    </div>
